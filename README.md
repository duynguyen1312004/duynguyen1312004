...
### 🎓 Kỹ thuật Máy tính | Khoa Điện tử Viễn thông (FETEL) - HCMUS
Hệ thống nhúng & Trí tuệ nhân tạo tại biên (TinyML) là niềm đam mê lớn nhất của mình. Mình luôn tìm cách tối ưu hóa sự giao thoa giữa phần cứng và phần mềm.

---

### 🚀 Dự án tiêu biểu (Featured Projects)

- **[TinyML ECG Monitor](https://github.com/duynguyen1312004/TinyML-ECG-Monitor-Project)**: Hệ thống giám sát tim mạch thời gian thực ứng dụng AI ngay trên thiết bị biên (ESP32).
- **[CineGo - Movie Ticket App](https://github.com/duynguyen1312004/CineGo)**: Ứng dụng đặt vé xem phim tích hợp Trợ lý ảo AI (Gemini) và Firebase.
...
![TinyML](https://img.shields.io/badge/AI-TinyML-blue?style=for-the-badge)
